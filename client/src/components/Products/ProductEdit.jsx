...
const ProductEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`/api/product/updateproducts/${id}`, {
        method: "POST",
                ...
                <div className=" w-[50%]">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="image2"
                      onChange={(e) =>
                        handleFileChange(e, setProductImageFile1)
                      }
                      className=" appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-500 focus:shadow-outline"
                      required
                    />
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="image3"
                      onChange={(e) =>
                        handleFileChange(e, setProductImageFile2)
                      }
                      className=" appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-500 focus:shadow-outline"
                      required
                    />
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="image4"
                      onChange={(e) =>
                        handleFileChange(e, setProductImageFile3)
                      }
                      className=" appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-500 focus:shadow-outline"
                      required
                    />
